    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
      <div className="flex flex-col md:flex-row justify-between items-end gap-4">
        <div className="flex-1 w-full">
          ...
          <p className="text-bamboo mb-4">Module 2: Users, Plans & Security</p>
          <div className="relative max-w-md">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-bamboo" size={18} />
            <input 
              type="text"
              placeholder="Search by name or email..."
              className="w-full bg-white border-2 border-bamboo/10 rounded-xl pl-10 pr-4 py-2 text-sm focus:border-hanko outline-none transition-all"
              value={searchTerm}
