...
const createDialogue = (
  ...
  title: string,
  jpTitle: string,
  lines: { s: "A" | "B"; j: string; r: string; e: string; b: string }[],
): ConversationTopic => ({
  id,
  title,
  jpTitle,
...
export const CONVERSATION_DATA: ConversationTopic[] = [
  ...
  createDialogue("ordering", "Ordering", "注文する", [
    {
      s: "A",
      j: "いらっしゃいませ。何名様ですか？",
      r: "Irasshaimase. Nanmeisama desu ka?",
      e: "Welcome. How many people?",
      b: "স্বাগতম। কতজন?",
    },
    {
      s: "B",
    ...
    },
    {
      s: "A",
      j: "こちらの席へどうぞ。",
      r: "Kochira no seki e douzo.",
      e: "Please come to this seat.",
      b: "অনুগ্রহ করে এই সিটে আসুন।",
    },
    {
      s: "B",
      j: "メニューを見せてください。",
      r: "Menyuu o misete kudasai.",
      e: "Please show me the menu.",
      b: "দয়া করে মেনুটা দেখান।",
    },
    {
      s: "A",
      j: "はい、どうぞ。",
    ...
    },
    {
      s: "B",
      j: "おすすめは何ですか？",
      r: "Osusume wa nan desu ka?",
      e: "What do you recommend?",
      b: "আপনার রিকমেন্ডেশন কী?",
    },
    {
      s: "A",
      j: "天ぷらセットが人気です。",
      r: "Tenpura setto ga ninki desu.",
      e: "The Tempura set is popular.",
      b: "তেম্পুরা সেটটি জনপ্রিয়।",
    },
    {
      s: "B",
      j: "じゃあ、それを二つください。",
      r: "Jaa, sore o futatsu kudasai.",
      e: "Then, please give us two of those.",
      b: "তাহলে, ওটা দুটো দিন।",
    },
    {
      s: "A",
      j: "お飲み物はどうしますか？",
      r: "Onomimono wa dou shimasu ka?",
      e: "What would you like for drinks?",
      b: "পানীয় কী নেবেন?",
    },
    {
      s: "B",
    ...
    },
    {
      s: "B",
      j: "すみません、トイレはどこですか？",
      r: "Sumimasen, toire wa doko desu ka?",
      e: "Excuse me, where is the restroom?",
      b: "শুনুন, টয়লেটটা কোথায়?",
    },
    {
      s: "A",
      j: "あちらの奥です。",
      r: "Achira no oku desu.",
      e: "It is in the back over there.",
      b: "ওই দিকে পিছনে।",
    },
    {
      s: "B",
    ...
    },
    {
      ...
      j: "いただきます。",
      r: "Itadakimasu.",
      e: "Let's eat (Thanks for the meal).",
      b: "খাওয়া শুরু করছি।",
    },
    {
      s: "B",
      j: "これ、とてもおいしいですね。",
      r: "Kore, totemo oishii desu ne.",
      e: "This is very delicious, isn't it?",
      b: "এটা খুব সুস্বাদু, তাই না?",
    },
    {
      s: "B",
      j: "すみません、お会計をお願いします。",
      r: "Sumimasen, okaikei o onegaishimasu.",
      e: "Excuse me, check please.",
      b: "শুনুন, বিলটা দিন প্লিজ।",
    },
    {
      s: "A",
      j: "はい、2000円になります。",
      r: "Hai, nisenen ni narimasu.",
      e: "Yes, that will be 2000 yen.",
      b: "হ্যাঁ, ২০০০ ইয়েন হয়েছে।",
    },
    {
      s: "B",
      j: "カードで払えますか？",
      r: "Kaado de haraemasu ka?",
      e: "Can I pay by card?",
      b: "কার্ডে কি বিল দেওয়া যাবে?",
    },
    {
      s: "A",
      j: "はい、大丈夫です。",
    ...
    },
    {
      s: "A",
      j: "ありがとうございました。",
      r: "Arigatou gozaimashita.",
      e: "Thank you very much.",
      b: "আপনাকে অনেক ধন্যবাদ।",
    },
  ]),
  createDialogue("shopping", "Shopping", "買い物", [
    ...
    },
    {
      s: "B",
      j: "これを見てもいいですか？",
      r: "Kore o mite mo ii desu ka?",
      e: "May I look at this?",
      b: "আমি কি এটা দেখতে পারি?",
    },
    {
      s: "A",
      j: "はい、どうぞ。手にとってご覧ください。",
      r: "Hai, douzo. Te ni totte goran kudasai.",
      e: "Yes, please. Feel free to pick it up.",
      b: "হ্যাঁ, প্লিজ। হাতে নিয়ে দেখুন।",
    },
    {
      s: "B",
      j: "これはいくらですか？",
    ...
    },
    {
      s: "B",
      j: "ちょっと高いですね。",
      r: "Chotto takai desu ne.",
      e: "It is a bit expensive.",
      b: "একটু বেশি দাম মনে হচ্ছে।",
    },
    {
      s: "B",
      j: "もっと安いのはありますか？",
      r: "Motto yasui no wa arimasu ka?",
      e: "Do you have a cheaper one?",
      b: "এর চেয়ে সস্তা কিছু আছে?",
    },
    {
      s: "A",
      j: "こちらはいかがですか？",
      r: "Kochira wa ikaga desu ka?",
    ...
    },
    {
      s: "B",
      j: "いいですね。これをください。",
      r: "Ii desu ne. Kore o kudasai.",
      e: "That's good. I'll take this.",
      b: "ভালো। এটাই দিন।",
    },
    {
      s: "B",
      j: "袋はいりません。",
      r: "Fukuro wa irimasen.",
      e: "I don't need a bag.",
      b: "ব্যাগ লাগবে না।",
    },
  ]),
];
...
const rawMinnaVocab = [
  ...
  },
  {
    ...
    romaji: "kaishain",
    en: "company employee",
    bn: "কোম্পানিতে চাকুরীরত ব্যক্তি",
    cat: "Occupation",
  },
  {
    lesson: 1,
  ...
  },
  {
    ...
    en: "nice to meet you",
    bn: "আপনার সাথে প্রথমবার দেখা হলো",
    cat: "Phrase",
  },
...
const rawGrammar = [
  {
    lesson: 1,
    rule: "N1 は N2 です",
    explanation: "Topic marker 'wa'. N1 is N2.",
    examples: "わたしは学生です (I am a student)",
  },
  {
    lesson: 1,
    rule: "N1 は N2 じゃありません",
    explanation: "Negative: N1 is not N2.",
    examples: "わたしは医者じゃありません (I am not a doctor)",
  },
  {
    lesson: 1,
    rule: "S か",
    explanation: "Question particle 'ka'.",
    examples: "あの方はどなたですか (Who is that person?)",
  },
  {
    lesson: 2,
    rule: "これ/それ/あれ",
    explanation: "Demonstratives (This/That/That over there)",
    examples: "これは本です (This is a book)",
  },
  {
    lesson: 2,
    rule: "この/その/あの N",
    explanation: "Modifying nouns.",
    examples: "この本はわたしのです (This book is mine)",
  },
  {
    lesson: 3,
    rule: "ここ/そこ/あそこ",
    explanation: "Place demonstratives.",
    examples: "ここは教室です (This is the classroom)",
  },
  {
    lesson: 4,
    rule: "Time に V",
    explanation: "Specific time particle 'ni'.",
    examples: "６時におきます (I wake up at 6)",
  },
  {
    lesson: 5,
    rule: "Place へ 行きます",
    explanation: "Direction particle 'e'.",
    examples: "日本へ行きます (I go to Japan)",
  },
];
...
const rawCounters = [
  ...
  {
    group: "Thin & Flat Things",
    ja: "いちまい",
    romaji: "ichimai",
    en: "one sheet",
  },
  {
    group: "Machines & Vehicles",
    ja: "いちだい",
    romaji: "ichidai",
    en: "one machine",
  },
  ...
  {
    group: "Floors of Building",
    ja: "いっかい",
    romaji: "ikkai",
    en: "1st floor",
  },
  {
    group: "Thin & Long Things",
    ja: "いっぽん",
    romaji: "ippon",
    en: "one long object",
  },
  {
    group: "Drinks in Cups & Glasses",
    ja: "いっぱい",
    romaji: "ippai",
    en: "one cup",
  },
  {
    group: "Small Animals & Fish",
    ja: "いっぴき",
    romaji: "ippiki",
    en: "one animal",
  },
...
const rawFormalInformal = [
  ...
  {
    polite: "暑いです (Atsui desu)",
    casual: "暑い (Atsui)",
    meaning: "Hot (weather)",
  },
  {
    polite: "静かです (Shizuka desu)",
    casual: "静かだ (Shizuka da)",
    meaning: "Quiet",
  },
  {
    polite: "きれいです (Kirei desu)",
    casual: "きれいだ (Kirei da)",
    meaning: "Pretty/Clean",
  },
  {
    polite: "学生です (Gakusei desu)",
    casual: "学生だ (Gakusei da)",
    meaning: "Is a student",
  },
  {
    polite: "そうです (Sou desu)",
    casual: "そうだ (Sou da)",
...
const generateKana = (): LearningItem[] => {
  ...
  const hBasicItems = h_basic.map((k, i) => ({
    id: `h-b-${i}`,
    ja: k.ja,
    romaji: k.romaji,
    en: k.romaji,
    type: "kana" as const,
    category: "Hiragana",
    variation: "basic" as const,
  }));
  const hDakItems = h_dakuten.map((k, i) => ({
    id: `h-d-${i}`,
    ja: k.ja,
    romaji: k.romaji,
    en: k.romaji,
    type: "kana" as const,
    category: "Hiragana",
    variation: "dakuten" as const,
  }));
  const hYouItems = h_youon.map((k, i) => ({
    id: `h-y-${i}`,
    ja: k.ja,
    romaji: k.romaji,
    en: k.romaji,
    type: "kana" as const,
    category: "Hiragana",
    variation: "youon" as const,
  }));

  const kBasicItems = k_basic.map((k, i) => ({
    id: `k-b-${i}`,
    ja: k.ja,
    romaji: k.romaji,
    en: k.romaji,
  ...
  const kDakItems = k_dakuten.map((k, i) => ({
    id: `k-d-${i}`,
    ja: k.ja,
    romaji: k.romaji,
    en: k.romaji,
  ...
  const kYouItems = k_youon.map((k, i) => ({
    id: `k-y-${i}`,
    ja: k.ja,
    romaji: k.romaji,
    en: k.romaji,
...
export const CONFUSING_PAIRS = [
  {
    label: "Shi vs Tsu (Katakana)",
    correct: "シ",
    wrong: "ツ",
    hint: "Shi looks up (smiling), Tsu looks down.",
  },
  {
    label: "So vs N (Katakana)",
    correct: "ソ",
    wrong: "ン",
    hint: "So looks down, N looks up.",
  },
  {
    label: "Wa vs Re (Hiragana)",
    correct: "わ",
    wrong: "れ",
    hint: "Wa is rounded, Re kicks out.",
  },
  {
    label: "Nu vs Me (Hiragana)",
    correct: "ぬ",
    wrong: "め",
    hint: "Nu has a loop (noodle), Me does not.",
  },
  {
    label: "Ru vs Ro (Hiragana)",
    correct: "る",
    wrong: "ろ",
    hint: "Ru has a loop at the end, Ro does not.",
  },
];
...
export const CONNECTOR_DATA: LearningItem[] = [
  ...
  },
  {
    ...
    romaji: "ga",
    en: "Subject Marker",
    usage: "Neko ga imasu (There is a cat)",
    type: "grammar",
    category: "Particle",
  },
  {
    ...
    romaji: "o",
    en: "Object Marker",
    usage: "Mizu o nomimasu (Drink water)",
    type: "grammar",
    category: "Particle",
  },
  {
    ...
    ja: "に",
    romaji: "ni",
    en: "Time/Target/Location",
    usage: "6-ji ni okimasu (Wake at 6)",
    type: "grammar",
    category: "Particle",
  },
  {
    ...
    usage: "Basu de ikimasu (Go by bus)",
    type: "grammar",
    category: "Particle",
  },
  {
    ...
    romaji: "e",
    en: "Direction",
    usage: "Nihon e ikimasu (Go to Japan)",
    type: "grammar",
    category: "Particle",
  },
  {
    ...
    romaji: "to",
    en: "And / With",
    usage: "Tomodachi to asobimasu (Play with friend)",
    type: "grammar",
    category: "Particle",
  },
  {
  ...
  },
  {
    ...
    ja: "や",
    romaji: "ya",
    en: "And (incomplete list)",
    usage: "Hon ya pen (Books and pens etc.)",
    type: "grammar",
    category: "Particle",
  },
];
